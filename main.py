...
Formats = {"/Users/suren/Movies/" : [".webm",".mkv",".flv",".vob",".ogv",".ogg",".drc",".gif","gifv",".mng",".avi",".mov",".qt",".wmv",".yuv",".rm",".rmvb",".asf",".amv",".mp4",".m4p",".m4v",".mpg",".mp2",".mpeg",".mpe",".mpv",".mpg",".mpeg",".m2v",".m4v",".svi",".3gp",".3g2",".mxf",".roq",".nsv",".flv",".f4v",".f4p",".f4a",".f4b"],
       "/Users/suren/Music/"   : [".mp3",".3gp",".aa",".aac",".aax",".act",".aiff",".amr",".ape",".au",".awb",".dct",".dss",".dvf",".flac",".gsm","iklax",".ivs","m4a",".m4p",".mmf",".mp3",".mpc",".msv",".off",".oga",".mogg",".opus",".ra",".rm","sln",".tta","vox",".wma",".webm",".8svx"],
    ...
    def clean(self,source_dir):
        for (dirpath, dirnames, filenames) in os.walk(source_dir):
            for filename in filenames:
                ...
                if extension in self.table:
                    shutil.move(dirpath+"/"+filename, self.table[extension]+"/"+filename)
